  ...
  render() {
    ...
    return (
      <Group>
        ...
        <StyledExpression x={expressionX} y={expressionY} width={expressionWidth} height={expressionHeight} expression={expression} todo={this.props.todo} onClick={this.props.onClick}/>
      </Group>
    );
  }
}
